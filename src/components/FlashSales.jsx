          ...
          {products.length > 0 ? (
            products.map((product, index) => (
              <div
                ...
                className={`w-[270px] group cursor-pointer bg-white rounded-xl border border-gray-100 hover:border-red-500/30 overflow-hidden hover:shadow-[0_8px_30px_rgba(220,38,38,0.1)] transition-all duration-500 ${animatedProducts[index] ? 'animate-fade-in-up' : 'opacity-0'}`}
              ...
              >
                ...
                <div className="px-5 pb-5">
                  ...
                  <button 
                    ...
                    className="w-full bg-black hover:bg-red-600 text-white py-3 rounded-lg text-xs font-bold uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 group/addbtn shadow-sm hover:shadow-md opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0"
                  >
